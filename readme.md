...
- Das Dark-Theme based on [forevolve/bootstrap-dark](https://github.com/forevolve/bootstrap-dark)
- Der GIF-Generator uses [lvandeve/lodepng](https://github.com/lvandeve/lodepng)
- JQuery UI [jquery/jquery-ui](https://github.com/jquery/jquery-ui) with UI lightness / UI darkness
- Changelog based on [bootstrap-timeline](https://bootstrapthemes.co/item/bootstrap-timeline/)