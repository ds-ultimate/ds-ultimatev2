...
Sollte der Fehler bestehen bleiben bitte einen Bug-Report erstellen',
  ...
  array (
    ...
    'err' => 
    array (
      'paylod_len' => 'Die Vorlage scheint unvollständig. Falls du meinst, dass dies ein Fehler ist, wende dich bitte and das Team',
      'unknown_building' => 'Die Vorlage enthält ein unbekanntes Gebäude, bitte wende dich an das Team',
      'name_not_found' => 'Die Vorlage scheint unvollständig. Falls du meinst, dass dies ein Fehler ist, wende dich bitte and das Team',
    ),
    'name' => 'Name',
