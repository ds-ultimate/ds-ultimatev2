...
Created at %CREATE_AT% with [url=%CREATE_WITHL%]%CREATE_WITH%[/url]',
    ...
    array (
      ...
      'ballGrey' => 'grey dot',
      'ballRed' => 'red dot',
      'ballYellow' => 'yellow dot',
      'devArcher' => 'defense against archer',
      'devCav' => 'defense against cavalry',
      'moveIn' => 'green arrow left',
      'moveOut' => 'red arrow right',
      'wbAdd' => 'add',
      'wbAlly' => 'defense against infantry',
      'wbCheckbox' => 'checked checkbox',
      'wbDie' => 'dice',
      'wbEye' => 'eye',
      'wbEyeForbidden' => 'crossed out eye',
      'wbRemove' => 'red x',
      'wbWarning' => 'warning',
    ),
    ...
    'dsuImportWrongWorld' => 'The plan that you tried to import is für another world',
    'errorInvalidJSON' => 'Incorrect input',
    'exportDSU' => 'Export for DS-Ultimate',
    'exportDSUDesc' => 'Exports the whole attackplan. So that it can be imported later.',
    'importDSU' => 'Import DS-Ultimate',
    'importDSU_helper' => 'Imports a previously exported attackplan',
    'importDSUSuccessTitle' => 'Import successful',
    'importDSUSuccess' => 'DS-Ultimate data has been imported successfully',
    'importError' => 'Import Fehler',
    'importWB' => 'Import Workbench',
    'importWB_helper' => 'Import attacks from your Workbench',
  ),
  'map' => 
  array (
...
If that problem persists please create a bug-report',
  ...
  array (
    'title' => 'Simulator',
    'catapultChange' => 'Damage from catapults:',
    'resultAttacker' => 'Attacker',
    'resultDefender' => 'Defender',
    'resultLoss' => 'Losses',
    'results' => 'Results',
    'resultSurvivor' => 'Survivors',
    'wallChange' => 'Damage from rams:',
    'attackerUnitInput' => 'Attacker troops',
    'catapultTarget' => 'Level of the catapult target',
    'catapultTargetsWall' => 'Capult targets the wall',
    'defenderUnitInput' => 'Defender troops',
    'luck' => 'Luck',
    'modifierInput' => 'Fight settings',
    'morale' => 'Morale',
    'nightBonus' => 'Nightbonus active',
    'simulate' => 'Save simulation',
