                        ...
                        @isset($playerOtherServers)
                            <div class="col-12 mt-3 mb-3">
                                ...
                                @foreach($playerOtherServers->getWorlds() as $worldModel)
                                    {!! \App\Util\BasicFunctions::linkPlayer($worldModel, $playerTopData->playerID, \App\Util\BasicFunctions::escape($worldModel->shortName()), 'btn btn-primary btn-sm mt-1', true) !!}
                                @endforeach
                            </div>
                        @endisset
                        <!--<div class="col">
