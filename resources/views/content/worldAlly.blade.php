...
@section('titel', $worldData->display_name.': '.__('ui.titel.overview').' '.__('ui.titel.ally'))

@section('content')
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="col-md-5 p-lg-5 mx-auto my-1 text-center">
                <h1 class="font-weight-normal">{{$worldData->display_name }}<br>{{ __('ui.tabletitel.overview').' '.__('ui.tabletitel.ally') }}</h1>
            </div>
        </div>
        <div class="col-12">
            <div class="card">
