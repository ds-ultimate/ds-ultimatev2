...
@php
    ...
    $worldData = \App\World::getWorld('de', 170);
                    ...
                    '<div class="col-4"></div>' +
                        '<div class="col-4">' +
                            '<div class="form-inline">' +
                                ...
                                '<input id="date_picker" class="form-control form-control-sm col-8" type="date" max="{{ \Illuminate\Support\Carbon::now()->subDay()->toDateString() }}" min="{{ \Illuminate\Support\Carbon::now()->subDays(30)->toDateString() }}">' +
                            '</div>' +
                        '<div class="col-4">' +
                    '</div>' +
                '</div>');
