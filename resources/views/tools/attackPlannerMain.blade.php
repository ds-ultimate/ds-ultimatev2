...
@push('js')
    ...
    <script>
        ...
        function edit(id) {
            ...
            $('input[name="spear"', context).val(rowData.spear);
            $('input[name="sword"', context).val(rowData.sword);
            $('input[name="axe"', context).val(rowData.axe);
            $('input[name="archer"', context).val(rowData.archer);
            $('input[name="spy"', context).val(rowData.spy);
            $('input[name="light"', context).val(rowData.light);
            $('input[name="marcher"', context).val(rowData.marcher);
            $('input[name="heavy"', context).val(rowData.heavy);
            $('input[name="ram"', context).val(rowData.ram);
            $('input[name="catapult"', context).val(rowData.catapult);
            $('input[name="knight"', context).val(rowData.knight);
            $('input[name="snob"', context).val(rowData.snob);
            $('input[name="note"', context).val(rowData.note);
